...
from learningflask.users.utils import save_picture, send_reset_email
...
def user_posts(username):
    ...
    return render_template('users/user_post.html', title='User Post', posts=posts, user=user)
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('users.login'))
    return render_template('users/reset_request.html', title='Rest Password', form=form)
...
def reset_token(token):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('users.login'))
    return render_template('users/reset_token.html', title='Rest Password', form=form)
